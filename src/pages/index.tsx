   ...
   <div>
     ...
     <header className="text-gray-400 bg-gray-900 body-font">
       <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
         ...
         <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-10 h-10 text-white p-2 bg-indigo-500 rounded-full" viewBox="0 0 24 24">
           ...
           <span className="ml-3 text-xl xl:block lg:hidden">Sadia Zain</span>
         </a>
         <div className="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
           <button className="inline-flex items-center bg-gray-800 border-0 py-1 px-3 focus:outline-none hover:bg-red-700 rounded text-base mt-4 md:mt-0">subscribe
     ...
     <section className="text-gray-400 bg-gray-900 body-font">
       <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
         <img className="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="SZ" src="https://thumbs.dreamstime.com/b/luxury-gold-letter-s-z-sz-vintage-decorative-ornament-stamp-wedding-logo-classy-icon-185435435.jpg" />
         <div className="text-center lg:w-2/3 w-full">
           <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">Web designer SEO</h1>
           <p className="leading-relaxed mb-8">I am Sadia Zain, a passionate and detail-oriented electronics engineer with over a decade of experience in designing,implementing, testing and delivering complex back-end and web applications. my journey has been fueled by a strong commitment to excellence and a deep love for problem-solving both in the technical and creative realms.  </p>
       ...
       <div className="container px-5 py-24 mx-auto">
         <div className="flex flex-col">
           ...
           <div className="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
             <h1 className="sm:w-2/5 text-white font-medium title-font text-2xl mb-2 sm:mb-0">Sadia Zain</h1>
         ...
         <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
           <div className="p-4 md:w-1/3 sm:mb-0 mb-6">
             <div className="rounded-lg h-64 overflow-hidden">
               <img alt="content" className="object-cover object-center h-full w-full" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQlOelpODH3gAfsIf1A9yOqrCQseNjSc5W1-g&s"/>
             </div>
           ...
           <div className="p-4 md:w-1/3 sm:mb-0 mb-6">
             <div className="rounded-lg h-64 overflow-hidden">
               <img alt="content" className="object-cover object-center h-full w-full" src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/atm-machine-design-template-32605fa1f3faa5cb845a6574bb2a06e8_screen.jpg?ts=1718985996" />
               </div>
           ...
           <div className="p-4 md:w-1/3 sm:mb-0 mb-6">
             <div className="rounded-lg h-64 overflow-hidden">
               <img alt="content" className="object-cover object-center h-full w-full" src="https://img.freepik.com/premium-vector/money-currency-exchange-money-transfer-stock-exchange-currencies-dollar-euro-pound-yen_228260-472.jpg?semt=ais_hybrid" />
             </div>
     ...
     <section className="text-gray-400 bg-gray-900 body-font">
       <div className="container px-5 py-24 mx-auto">
         <div className="text-center mb-20">
           <h1 className="sm:text-3xl text-2xl font-medium text-center title-font text-white mb-4">Sadia Zain</h1>
         ...
         <div className="lg:w-1/2 md:w-2/3 mx-auto">
           <div className="flex flex-wrap -m-2">
             ...
             <div className="p-2 w-full pt-8 mt-8 border-t border-gray-800 text-center">
               <a className="text-indigo-400">zsaif7820@gmail.com</a>
               <p className="leading-normal my-5">Sadia Zain
     ...
     <footer className="text-gray-400 bg-gray-900 body-font">
       <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
         <a className="flex title-font font-medium items-center md:justify-start justify-center text-white">
           ...
           <span className="ml-3 text-xl">Sadia Zain</span>
         </a>
         <p className="text-sm text-gray-400 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-800 sm:py-2 sm:mt-0 mt-4">© 2024 Sadia Zain —
           <a href="https://twitter.com/knyttneve" className="text-gray-500 ml-1" target="_blank" rel="noopener noreferrer">@Sadia Zain</a>
         </p>
